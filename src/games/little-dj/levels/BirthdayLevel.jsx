...
const KEYFRAMES_ID = 'didit-birthday-level-keyframes';
const keyframesCSS = `
...
// Happy Birthday mapped to SOLFEGE indices
// Do Do Re Do Fa Mi | Do Do Re Do Sol Fa
const MELODY = [0, 0, 1, 0, 3, 2, 0, 0, 1, 0, 4, 3];
...
export default function BirthdayLevel({ onMilestone }) {
        ...
        <div style={{
          ...
          {TITLE.split('').map((ch, i) => (
            <span
              ...
              style={{
                color: done
                  ? SOLFEGE[MELODY[i % MELODY.length]].color
                  : i < step
