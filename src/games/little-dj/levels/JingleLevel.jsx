...
const KEYFRAMES_ID = 'didit-jingle-level-keyframes';
const keyframesCSS = `
...
// Jingle Bells mapped to SOLFEGE indices
// Mi Mi Mi | Mi Mi Mi | Mi Sol Do Re Mi
// Fa Fa Fa Fa | Fa Mi Mi Mi | Re Re Mi Re Sol
const MELODY = [2, 2, 2, 2, 2, 2, 2, 4, 0, 1, 2, 3, 3, 3, 3, 3, 2, 2, 2, 1, 1, 2, 1, 4];
...
export default function JingleLevel({ onMilestone }) {
