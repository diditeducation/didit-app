...
export default function SuccessScreen({ visible, gameName, learnedText, onPlayAgain, onBack, savedCoins = null, boughtItems = null, boughtLabel = 'You bought', onFeedback, showShare = false, gameId = null, featuredContent = null }) {
