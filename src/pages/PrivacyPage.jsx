...
export default function PrivacyPage() {
  ...
  return (
    <LegalPage title="Privacy Policy" updated={LEGAL.effectiveDate}>
      ...
      <p>Did·It is set up and managed by a parent or carer. We don't knowingly collect personal information from children, and the games don't ask children for personal details.</p>
      ...
      <p>To provide and secure Did·It, remember your purchase and sign you in, improve the games, and respond to you.</p>
      ...
      <p>We use your browser's storage to keep you signed in and for basic, non-advertising analytics. We don't use advertising cookies.</p>
