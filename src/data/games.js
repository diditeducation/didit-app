...
export const GAMES = [
  ...
  },
  {
    ...
    skills: ['Circuits', 'Cause & effect', 'Binary logic'],
  ...
  },
  {
    ...
    instructions: 'Crack, pour and stir through the recipe, one step at a time.',
  ...
  },
  {
    ...
    instructions: 'Tap the keys to learn Do Re Mi, then play songs note by note.',
  ...
  },
  {
    ...
    instructions: 'Steer the rat to the cheese, one arrow tap at a time.',
  ...
  },
  {
    ...
    instructions: 'Add atoms to balance the seesaw and meet the elements along the way.',
  ...
  },
  {
    ...
    desc: 'Tap the glowing stars in order to reveal the constellation hiding in the night sky.',
  ...
  },
  {
    ...
    instructions: 'Drag the colourful cutouts around to build a collage all their own.',
  ...
  },
  {
    ...
    instructions: 'Keep the card or let it go: your little one decides each round.',
  ...
  },
  {
    ...
    instructions: 'Sort the shapes into their homes, learning one new rule at a time.',
    skills: ['Categorisation', 'Structured thinking', 'Flexibility'],
    bgImage: '/backgrounds/background-blue.png',
    ...
    parentGuide: {
      ...
      ladder: [
        ...
        { label: 'Big concept',   title: 'Structured thinking', desc: 'Carving up the world cleanly — no overlap, nothing missed.',  color: colors.coralMid },
      ],
      tip: {
        text: "When level 2 starts, ask: 'where does the red triangle go now?' On level 1 it lived in the Red home; now it has to find a new home. Watching them spot that is the whole lesson in one moment.",
